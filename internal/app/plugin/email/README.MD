...
#### 1. 前往GVA主程序下的initialize/router.go 在Routers 方法最末尾按照你需要的及安全模式添加本插件
	...
	PluginInit(PrivateGroup, email.CreateEmailPlug(
		global.SYS_CONFIG.Email.To,
		global.SYS_CONFIG.Email.From,
		global.SYS_CONFIG.Email.Host,
		global.SYS_CONFIG.Email.Secret,
		global.SYS_CONFIG.Email.Nickname,
		global.SYS_CONFIG.Email.Port,
		global.SYS_CONFIG.Email.IsSSL,
		))
