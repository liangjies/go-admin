...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/sysUserLogin/createSysUserLogin": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        "description": "创建SysUserLogin",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/system.SysUserLogin"
                        }
                    }
                ],
                "responses": {
        ...
        "/sysUserLogin/deleteSysUserLogin": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/sysUserLogin/deleteSysUserLoginByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/sysUserLogin/getSysUserLoginList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "分页获取SysUserLogin列表,返回包括列表,总数,页码,每页数量",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
